      ...
      <div id="nav">
        <svg
          ...
          <path
            ...
            fill="#f2f2f2"
          ></path>
          <circle cx="94.60365" cy="105.66791" r="32.5874" fill="#f7c948"></circle>
          <path
            ...
            fill="#f2f2f2"
          ></path>
          <circle cx="896.77566" cy="620.24394" r="32.5874" fill="#f7c948"></circle>
          <rect x="115.5" y="152.67774" width="788" height="358" fill="#3f3d56"></rect>
          <rect x="128.5" y="165.67774" width="762" height="325" fill="#fff"></rect>
          <rect x="739" y="475.17774" width="74" height="25" fill="#3f3d56"></rect>
          <rect x="681" y="494.17774" width="54" height="7" fill="#f7c948"></rect>
          <polyline
          ...
          <polyline
            ...
            stroke-width="2"
          ></polyline>
          <circle cx="304.5" cy="288.67774" r="9" fill="#f7c948"></circle>
          <circle cx="388.5" cy="288.67774" r="9" fill="#f7c948"></circle>
          <polyline
          ...
          <polyline
            ...
            stroke-width="2"
          ></polyline>
          <circle cx="526.5" cy="310.67774" r="9" fill="#f7c948"></circle>
          <circle cx="720.5" cy="257.67774" r="9" fill="#f7c948"></circle>
          <circle cx="626.5" cy="292.67774" r="9" fill="#f7c948"></circle>
          <line
            x1="327.5"
            y1="347.67774"
            x2="379.5"
          ...
          <circle
            ...
            stroke-width="2"
          ></circle>
          <ellipse cx="152" cy="742.17774" rx="152" ry="28" fill="#f2f2f2"></ellipse>
          <polygon
          ...
          <path
            ...
            fill="#2f2e41"
          ></path>
          <circle cx="194.11408" cy="228.8283" r="24.36468" fill="#fbbebe"></circle>
          <path
...
:root {
  --white: hsl(210, 36%, 96%);
  --lightergrey: hsl(212, 33%, 89%);
  --lightgrey: hsl(210, 31%, 80%);
  --grey: hsl(209, 23%, 60%);
  --darkgrey: hsl(209, 28%, 39%);
  --darkergrey: hsl(209, 34%, 30%);
  --black: hsl(209, 61%, 16%);

  --lighterprimary: hsl(48, 100%, 88%);
  --lightprimary: hsl(48, 94%, 68%);
  --primary: hsl(44, 92%, 63%);
  --darkprimary: hsl(42, 87%, 55%);
  --darkerprimary: hsl(29, 80%, 44%);
}
...
#nav {
  ...
  .nav-container {
    @include container(var(--darkergrey));
    align-self: center;
